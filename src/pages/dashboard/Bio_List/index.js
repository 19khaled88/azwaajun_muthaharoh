...
const Account = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="py-2 pl-2 text-sm text-gray-600">Admin panel / All Bio-data(Aproved & pending) </div>
      <div>
        <div class="w-full">

          <div class="px-2 py-4">
            <div class="flex items-center justify-between">
              <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">All Bio Data({bio.length})</p>
