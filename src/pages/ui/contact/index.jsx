        ...
        <div style={{ boxShadow: 'rgba(0, 0, 0, 0.24) 0px 3px 8px' }} className=' rounded mx-5 mt-5 mb-10 lg:col-span-2 flex flex-col gap-3'>
          ...
          <form class="bg-white  px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex items-center justify-between">
              <button style={{ backgroundColor: '#10B981' }} class=" text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                Send Message
              </button>
